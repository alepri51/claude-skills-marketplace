# Сбор содержимого страницы Yandex Wiki

Полный набор данных страницы: метаданные + контент + breadcrumbs +
комментарии + вложения. Wiki API возвращает большую часть по запросу
полей `fields=...`, комментарии и вложения — отдельными запросами.
