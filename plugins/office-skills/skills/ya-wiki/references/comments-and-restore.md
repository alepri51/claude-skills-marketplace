...
python scripts/wiki.py page_add_comment '{
  "page_id": 12345,
  "body": "GSD: задача взята в работу"
}'
```
...
Куда сохранять:
- В комментарий к Tracker-задаче, инициировавшей удаление.
- В отдельный файл в `.planning/phase-X/`, если часть workflow.
- Не печатать в общий чат — токен даёт право на восстановление.
