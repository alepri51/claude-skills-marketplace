...
> `issue_get_transitions`, `issue_close`. **Какая роль когда что
> меняет** — описано в `ANALYST.md` (для аналитика) и `DEV.md` (для
> разработчика). Здесь — только синтаксис вызовов.
